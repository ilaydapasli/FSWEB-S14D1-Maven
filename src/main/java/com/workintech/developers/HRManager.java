...
public class HRManager extends Employee {
    ...
    @Override
    public void work() {
        System.out.println("HRManager is managing employees and updating their records.");
        setSalary(getSalary() + 500); // Increment salary
    }
    public void addEmployee(JuniorDeveloper juniorDeveloper) {
        ...
        System.out.println("JuniorDeveloper array is full. Cannot add new developer.");
    }
    ...
    public void addEmployee(MidDeveloper midDeveloper) {
        ...
        System.out.println("MidDeveloper array is full. Cannot add new developer.");
    }
    ...
    public void addEmployee(SeniorDeveloper seniorDeveloper) {
        ...
        System.out.println("SeniorDeveloper array is full. Cannot add new developer.");
    }
}
